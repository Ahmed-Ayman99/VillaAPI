...
namespace VillaAPI.Migrations
{
    ...
    [Migration("20240531095518_inititals")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VillaAPI.Models.AppplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VillaAPI.Models.AppplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VillaAPI.Models.VillaNumber", b =>
                {
                    b.HasOne("VillaAPI.Models.Villa", "Villa")
                        .WithOne("VillaNumber")
                        .HasForeignKey("VillaAPI.Models.VillaNumber", "Villa_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
